...
public class OperationResult
{
    ...
    public static OperationResult Success(string message = "Amal muvaffaqiyatli bajarildi.") => new(true, message);
...
public sealed class OperationResult<T> : OperationResult
{
    ...
    public static OperationResult<T> Success(T value, string message = "Amal muvaffaqiyatli bajarildi.") => new(true, value, message);
